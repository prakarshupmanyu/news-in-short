...
from keras.layers.core import Dense, Activation, Dropout, RepeatVector, SpatialDropout1D, Lambda
...
with open('../DataExtractor/art/vocabEmbeddings.pkl', 'rb') as pkfile:
...
with open('../DataExtractor/art/train_data.pkl', 'rb') as f:
...
model.add(Embedding(
    ...
    mask_zero=True,
    name='embedding_1'))
model.add(SpatialDropout1D(rate=prob_emb))

for i in range(rnn_layers):
    """
    lstm = LSTM(rnn_size, return_sequences=True,
                W_regularizer=regularizer, U_regularizer=regularizer,
                b_regularizer=, dropout_W=prob_W, dropout_U=prob_U,
                name='lstm_%d'%(i+1)
                  )    
    """
    #Keras 2
...
if 'train' and os.path.exists('/home/melvin/Documents/USC/news-in-short/DataExtractor/art/train.hdf5'):
    model.load_weights('/home/melvin/Documents/USC/news-in-short/DataExtractor/art/train.hdf5')
